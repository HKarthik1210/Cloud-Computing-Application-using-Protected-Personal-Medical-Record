...
<html lang="en">
   ...
   <body class="clinic_version" style="background-color: black">
      <!-- LOADER -->
      <div id="preloader">
...
related data providers without knowing its query content.</p>
      ...
      <div style="background: lightblue; height: 1000px; margin-top: 60px;">
          <br> <h2 style="margin-left: 40%; color:darkorange; font-family: cursive;">Welcome Cloud Server </h2>
    	<style>
    	h2{
    	 margin-top:60px;
    	 font-size:30px;
        ...
        P{
    		...
    		<center>
    			<table>
                            <tr><td><a href="Authorize_Owner.jsp"><strong>View Doctor & Authorize</strong></a></td></tr>
                            <tr><td><a href="Authorize_User.jsp"><strong>View Data User & Authorize</strong></a></td></tr>    
                            <tr><td><a href="View_Patient.jsp"><strong>View Patient Details</strong></a></td></tr>
                            <tr><td><a href="View_Search.jsp"><strong>View Search Details</strong></a></td></tr>
                            <tr><td><a href="attacker.jsp"><strong>List OF Attackers </strong></a></td></tr>
                            <tr><td><a href="Graph.jsp"><strong>Result based on Keyword count based</strong></a></td></tr>
                            <tr><td><a href="Graph1.jsp"><strong>View Attacker Result</strong></a></td></tr>
    			</table>
    		</center>
    	</div>
      <!-- end copyrights -->
